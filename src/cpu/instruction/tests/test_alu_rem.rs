...
mod test_alu {
    ...
    fn test_rem() {
        ...
        cpu.pc = 0x10;
        cpu.opcode = OP::ALU;
        cpu.instruction = InstructionBuilder.alu(F7_M_EXTENSION, F3::REM, REG_S0, REG_S1, REG_S0);
    ...
    fn test_remu() {
        ...
        cpu.pc = 0x10;
        cpu.opcode = OP::ALU;
        cpu.instruction = InstructionBuilder.alu(F7_M_EXTENSION, F3::REMU, REG_S0, REG_S1, REG_S0);
